      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildDelarContainer(
                Icons.view_week, 'Valley Road Motors', mpinkColor),
            SizedBox(
              height: 10,
            ),
            _buildDelarContainer(
                Icons.panorama_fish_eye, 'National Car Rental', mblueColor),
            SizedBox(
              height: 15,
            ),
          ],
...
class CarItem extends StatefulWidget {
  ...
  const CarItem({Key? key, required this.carDetails, required this.press})
      : super(key: key);
        ...
        Column(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 13, color: Colors.white, letterSpacing: 1.1),
            ),
          ],
        ),
        Spacer(),
        Column(
          ...
          children: <Widget>[
            ...
            Text(
              '23 Offers',
              style: TextStyle(
                  fontSize: 13, color: Colors.blueAccent, letterSpacing: 1.1),
            ),
          ],
        )
      ],
